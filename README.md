...
Trong một lần chạm trán với Team Rocket, Pikachu không may bị thất lạc trong một khu rừng rậm bí ẩn. Không có Ash bên cạnh, Pikachu buộc phải tự mình tìm đường vượt qua những khu vực nguy hiểm, nơi có các Pokémon mạnh mẽ đang canh giữ từng vùng đất.

Mỗi màn chơi đại diện cho một thử thách trong hành trình trở về. Khi đánh bại boss cuối cùng là Mewtwo, Pikachu được dịch chuyển trở về bên Ash, khép lại hành trình sinh tồn và đoàn tụ.
